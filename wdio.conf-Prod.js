...
exports.config = {
    ...
    baseUrl: 'https://fieldbook.mottmac.com/',
    ...
    services: [ 
        ...
        // The options
        {
            ...
            baselineFolder: join(process.cwd(), './tests/sauceLabsBaseline-Prod/'),
    ...
    before: function () {
        ...
        //$('img[src="/Images/Fieldbook_Project cards(439).png').click()
        //browser.pause(20000)
        //browser.switchWindow('UGI_FB4-TST')
